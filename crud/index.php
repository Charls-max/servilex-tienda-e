...
<!-- Slider -->
<!-- <div class="d-flex flex-column bd-highlight align-content-center p-3 mt-5 mw-100"> -->
  <div class="d-flex flex-column justify-content-center p-3 mt-5">
  <br>
  <br>
  <br><hr>
  Slider
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../img/camisas.png" class="d-block w-50" alt="Camisas">
    </div>
    <div class="carousel-item">
      <img src="../img/sacos.png" class="d-block" alt="Sacos">
    </div>
    <div class="carousel-item">
      <img src="../img/zapatos.png" class="d-block" alt="Zapatos">
    </div>
  </div>
